import CreateEventStaffAccount from 'components/molecules/m-createEventStaffAccount';
...
const EventStaffRegister = () => {
  const [userTab, setUserTab] = useState<'details' | 'verify' | 'welcome'>('details');
  const [email, setEmail] = useState<string>('');

  const tabContent = {
    details: <CreateEventStaffAccount setUserTab={setUserTab} setEmail={setEmail} />,
...
export default EventStaffRegister;
