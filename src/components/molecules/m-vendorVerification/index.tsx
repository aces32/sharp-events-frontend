...
const VendorVerification = ({ setVendorTab, email, setVendorId, setVendorName }: Props) => {
  ...
  const handleSubmit = async () => {
    ...
    if (response?.code === '00') {
      const vendorId = response?.data?.vendor?.[0]?.vendorId;
      const vendorName = response?.data?.vendor?.[0]?.vendorName;
