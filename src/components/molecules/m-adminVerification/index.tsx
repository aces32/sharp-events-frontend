...
const AdminVerification = ({ setAdminTab, email, setCompanyId, setCompanyName }: Props) => {
  ...
  const handleSubmit = async () => {
    ...
    if (response?.code === '00') {
      const companyId = response?.data?.eventCenter?.[0]?.companyId;
      const companyName = response?.data?.eventCenter?.[0]?.companyName;
