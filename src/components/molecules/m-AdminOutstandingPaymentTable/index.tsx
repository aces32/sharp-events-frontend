...
const data: DataProps[] = [
  ...
  {
    id: '002',
    eventName: 'Happily EverAfter Wedding Reception',
    date: '20/07/2024',
    client: 'Ahmed Yusuf',
    amount: '₦ 500,000',
    status: 'Pending',
  },
  {
    ...
    eventName: 'TechTalks Seminar Series',
...
const AdminOutstandingPaymentTable = () => {
  ...
  return (
    <div className="mt-5 w-full rounded-lg bg-white px-3 py-9 lg:px-6">
      <h3 className="pb-4 font-Rubik text-base font-semibold">Outstanding Payments</h3>
...
export default AdminOutstandingPaymentTable;
