...
const data: DataProps[] = [
  {
    id: '001',
    cancelledDate: '28/07/2024',
    date: '28/07/2024',
    client: 'Sadiq Abdullahi',
    status: 'Confirmed',
    reason: 'Client would like to reschedule their booking due to a conflict.',
  },
  {
    id: '002',
    cancelledDate: '20/07/2024',
    date: '20/07/2024',
    client: 'Ahmed Yusuf',
    status: 'Pending',
    reason: 'Client would like to reschedule their booking due to a conflict.',
...
const columns = [
  ...
  columnHelper.accessor('cancelledDate', {
...
const VendorCancelledBookingTable = () => {
  ...
  return (
    <div className="mt-5 w-full rounded-lg bg-white px-3 py-9 lg:px-6">
      <h3 className="pb-4 font-Rubik text-base font-semibold">Cancellations</h3>
...
export default VendorCancelledBookingTable;
