...
import VendorDashboardSideNavItems from 'components/organisms/o-vendorDashboardSidebarItem';

const VendorDashboardLayout = () => {
  return (
    <div>
      <div className="hidden md:block">
        <SideBar NavItems={VendorDashboardSideNavItems} />
      </div>

      <div
        className={`absolute left-0 top-0 min-h-screen w-full  md:left-[250px] md:w-[calc(100%-250px)] `}
      >
        <TopNavigation navItem={VendorDashboardSideNavItems} />
...
export default WithDashboard(VendorDashboardLayout);
